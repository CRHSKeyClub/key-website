...
-- Step 1: First, see both accounts (optional - just to verify)
SELECT 
  id,
  s_number,
  name,
...
-- Step 2: Run the merge (this will automatically detect which account to keep/delete)
DO $$
DECLARE
...
BEGIN
  -- Find account with hours (KEEP THIS ONE)
  ...
  -- Find account without hours (DELETE THIS ONE)
  ...
  -- Step 1: Update hour_requests
  RAISE NOTICE '🔄 Step 1: Updating hour_requests...';
  ...
  -- Step 2: Update meeting_attendance (delete duplicates first)
  RAISE NOTICE '';
  RAISE NOTICE '🔄 Step 2: Updating meeting_attendance...';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '🔄 Step 3: Updating event_attendees...';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '🔄 Step 4: Deleting duplicate student record...';
